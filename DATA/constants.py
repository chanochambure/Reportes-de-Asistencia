...
def plus_one_day(str_date):
	return str(to_date(str_date,True)+datetime.timedelta(1,0))
...
# VALID TIPO
def valid_tipo(str_t):
	return str_t=="E" or str_t=="e" or str_t=="S" or str_t=="s"

def to_tipo(str_t):
	if(str_t=="E" or str_t=="e"):
		return False
	if(str_t=="S" or str_t=="s"):
		return True
	return None
...
SPLIT_TABLE_WORKERS					= ";"
SEARCH_MARKS_TITLE_ROWS				= "Fecha - Hora;Tipo;Activo;Accion"
SPLIT_TABLE_MARKS					= ";"
...
ADMIN_INSERT_MARK_TYPE				= "Tipo"
MARK_TYPE_INTRO_NAME				= "Entrada"
MARK_TYPE_EXIT_NAME					= "Salida"
CREATE_WORKER_INVALID_LEN			= "El PIN debe contener menor o igual a 8 digitos"
...
ADMIN_MOFIDY_MARKS_X					= 8
ADMIN_MOFIDY_MARKS_Y					= 4
GRID_X_POSITION_MODIFY_MARK				= 7
GRID_Y_POSITION_MODIFY_MARK				= 1
GRID_X_POSITION_BACK_MODIFY_MARK		= 7
...
BUTTON_REPORTES_HORARIO						= "Horarios de Trabajadores"
...
REPORTES_HORARIO_TITLE						= "Horarios de Trabajadores"
...
SEARCH_SEE_REPORTES_HORARIO_MESSAGE			= "Ver Horarios"
...
LISTA_TABLE_HORARIO							= ["Fecha","Entrada","Salida"]
...
#NUMBERS REPORTES
GRID_X_MAIN_WINDOW_REPORTES					= 8
GRID_Y_MAIN_WINDOW_REPORTES					= 3
GRID_X_POSITION_TITLE_R						= 0
GRID_X_POSITION_EXIT_R						= 7
GRID_X_POSITION_REPORTE_HORAS_A_R			= 6
GRID_X_POSITION_REPORTE_LUNCHTIME_R			= 3
GRID_X_POSITION_REPORTE_HORARIO_R			= 2
GRID_X_POSITION_REPORTE_TARDANZA_R			= 5
GRID_X_POSITION_REPORTE_HORAS_R				= 4
...
MARK_TYPE_ENTRADA							= False
MARK_TYPE_SALIDA							= True
